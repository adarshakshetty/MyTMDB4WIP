package com.wipro.movie.feature.trending.repository.mediator
...
class TrendingRemoteMediatorTest {
    ...
    private lateinit var trendingRemoteDataSource: DummyTrendingRemoteDataSourceImpl
    private lateinit var trendingLocalDataSource: TrendingLocalDataSource

    @Before
    fun setUp() {
        hiltRule.inject()
        trendingRemoteDataSource = DummyTrendingRemoteDataSourceImpl()
