...
import com.wipro.movie.core.common.extensions.navigateToMovie
import com.wipro.movie.core.common.util.ThemeUtils
import com.wipro.movie.core.ui.base.BaseFragment
import com.wipro.movie.core.ui.recyclerview.SpacingItemDecoration
import com.wipro.movie.feature.trending.R
import com.wipro.movie.feature.trending.databinding.FragmentTrendingBinding
import com.wipro.movie.feature.trending.di.FooterLoadStateAdapter
import com.wipro.movie.feature.trending.di.HeaderLoadStateAdapter
import com.wipro.movie.feature.trending.presentation.adapters.TrendingMovieLoadStateAdapter
import com.wipro.movie.feature.trending.presentation.adapters.TrendingMoviesAdapter
...
class TrendingFragment : BaseFragment<FragmentTrendingBinding>(
    ...
    private fun subscribeObservers() {
        ...
        collectLatestLifecycleFlow(adapter.loadStateFlow) {
            binding.fragmentTrendingSwipeRefreshLayout.isRefreshing =
