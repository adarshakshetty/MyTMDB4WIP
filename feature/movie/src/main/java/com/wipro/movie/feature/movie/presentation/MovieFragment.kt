...
import com.wipro.movie.core.common.extensions.collectLatestLifecycleFlow
import com.wipro.movie.core.common.extensions.orFalse
import com.wipro.movie.core.ui.base.BaseFragment
import com.wipro.movie.core.ui.extensions.setTextIfAvailableOrHide
import com.wipro.movie.core.ui.extensions.setVisible
import com.wipro.movie.feature.movie.R
import com.wipro.movie.feature.movie.databinding.FragmentMovieBinding
import com.wipro.movie.feature.movie.domain.model.Movie
import dagger.hilt.android.AndroidEntryPoint
import com.wipro.movie.core.ui.R as uiR
...
class MovieFragment : BaseFragment<FragmentMovieBinding>(
    ...
    private fun updateUi(movie: Movie) {
        with(binding) {
            ...
            Glide.with(requireContext()).load(movie.posterUrl).centerCrop()
                .into(fragmentMovieImageviewMovie)
        }
    }
    ...
    private fun initErrorHandler() {
        ...
        errorHandler.defaultTextPrimaryAction =
            requireContext().getString(uiR.string.text_button_go_back)
    }
    ...
    private fun adjustMenuItemWatchlistAction() {
        val itemWatchlistAction =
            binding.fragmentMovieToolbar.toolbar.menu.findItem(R.id.item_toolbar_watchlist_action)
        itemWatchlistAction?.apply {
            if (isMovieInWatchlist) {
                title =
                    requireContext().getString(R.string.title_toolbar_menu_item_watchlist_action_remove)
                setIcon(uiR.drawable.ic_fill_favorite_24)
            } else {
                title =
                    requireContext().getString(R.string.title_toolbar_menu_item_watchlist_action_add)
